...
__export(index_exports, {
  CONCLAVE_PROGRAM_ID: () => CONCLAVE_PROGRAM_ID,
  ConclaveClient: () => ConclaveClient,
  getMemberPda: () => getMemberPda,
  getMessagePda: () => getMessagePda,
  getProposalPda: () => getProposalPda,
  getRoomPda: () => getRoomPda,
  getSessionPda: () => getSessionPda,
  getTreasuryPda: () => getTreasuryPda,
  getVoteCommitmentPda: () => getVoteCommitmentPda
});
...
var CONCLAVE_PROGRAM_ID = new import_web3.PublicKey(
